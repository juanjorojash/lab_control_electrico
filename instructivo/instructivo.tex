...
\input{instructivo/introduccion_arduino}
\input{instructivo/combinacionales}
\input{instructivo/flip_flops}
\input{instructivo/cableada}
\input{instructivo/tension_reducida}
\input{instructivo/variadores}
\input{instructivo/logo}
\input{instructivo/automatas}
