\graphicspath{{../assets/99_appendices/}{../assets/common/}}
...
Las instrucciones y funciones del lenguaje C++ para Arduino pueden ser consultadas en el siguiente \href{https://www.arduino.cc/reference/en/}{enlace}.
...
Puede encontrar información adicional en el siguiente \href{https://es.wikipedia.org/wiki/Sistema_combinacional}{enlace}.   

\subsection{Implementación de expresiones Booleanas}
...
\begin{equation}
	F(I_0,I_1,I_2,I_3,S_1,S_0)=I_0\bar{S_1}\bar{S_0}+I_1S_1\bar{S_0}+I_2\bar{S_1}S_0+I_3S_1S_0
\end{equation} 
...
\label{ApendiceA1}
{\scriptsize 
    \lstinputlisting[language=Arduino, numbers=none, showstringspaces=false]{../../student_templates/laboratory_01/activity_01/activity_01.ino}
}

\section{Código actividad 2}
\label{ApendiceA2}
{\scriptsize 
    \lstinputlisting[language=Arduino, numbers=none, showstringspaces=false]{../../student_templates/laboratory_01/activity_02/activity_02.ino}
}	
