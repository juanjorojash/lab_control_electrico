...
\makeatletter
\def\input@path{{../theme/}{../../common/}}
\makeatother
\graphicspath{{../assets/01_introduction_to_arduino/}}
\usetheme{Bruno}
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    {
        \includegraphics[width=0.55\textwidth]{embebidos.png}
    };
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[remember picture, overlay]
    \node[above=0.5cm] at (current page.south) 
    {
        \includegraphics[width=0.5\textwidth]{ATMEGA2560.png}
    };
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[remember picture, overlay]
    \node[above=0.5cm] at (current page.south) 
    {
        \includegraphics[width=0.5\textwidth]{ESP32.jpeg}
    };
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    {
        \includegraphics[width=0.7\textwidth]{niveles.jpg}
    };
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[remember picture, overlay]
    \node[above] at (current page.south) 
    {
        \includegraphics[width=0.75\textwidth]{compiladovrsinterpretado.jpg}
    };
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    {
        \includegraphics[width=0.8\textwidth]{analogicavrsdigital.jpg}
    };
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    {
        \includegraphics[width=0.7\textwidth]{sistema_adquisicion.jpg}
    };
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    {
        \includegraphics[width=0.8\textwidth]{convAD.jpg}
    };
\end{tikzpicture}
\end{frame}
...
\begin{tikzpicture}[remember picture, overlay]
    \node[above=0.6cm] at (current page.south) 
    {
        \includegraphics[width=0.8\textwidth]{muestreo.jpg}
    };
\end{tikzpicture}
\end{frame}
...
%             \begin{center}
%                \includegraphics[width=\textwidth]{../assets/01_introduction_to_arduino/tostadora.jpg}\\
...
%         \begin{column}{0.4\textwidth}
%             \begin{center}
%                \includegraphics[width=0.8\textwidth]{../assets/01_introduction_to_arduino/bourdon.jpg}\\
